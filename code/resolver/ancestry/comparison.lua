...
local resolver_factory = require("code.resolver.ancestry.resolver")
local effective = require("code.resolver.ancestry.effective-output")
...
function comparison.build(material_flow, production_flow, options)
  ...
  local root_aliases, exact_components = roots.build(material_flow, root_policy, options.materials)
