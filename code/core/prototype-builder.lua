...
function prototype_builder.ensure_scrap_item(data_table, scrap_defines)
  ...
  local existing_scrap_item = data_table_writer.generated_item(data_table, scrap_name)
  ...
  local scrap_pictures = data_table.constants.scrap_pictures
  local scrap_icons = data_table.constants.icon_scrap
...
function prototype_builder.ensure_recycle_recipe(data_table, recipe_defines)
  ...
  local existing_recycle_recipe = data_table_writer.generated_recipe(data_table, recipe_name)
...
function prototype_builder.ensure_technology(tech_defines)
  ...
  local recycle_recipe = data_table_writer.generated_recipe(tech_defines.data_table, unlock_recipe_name)
    ...
    for _, effect in ipairs(tech.effects or {}) do
        if effect.type == "unlock-recipe" then
          if effect.recipe == tech_defines.recipe_name then
            local technology = data_table_writer.generated_technology(tech_defines.data_table, recycle_recipe_name) or scrap_technology
