...
---@field display_panel_text string|number|boolean|nil|table
...
---@field remove_alert fun(entity: LuaEntity, prototype: EntityID, position: MapPosition, type: defines.alert_type, surface: SurfaceIdentification, icon: SignalID, message: string|number|boolean|nil|table)
